...
# ./grid_search_qsub_step2.sh CRC_thomas_otu raw none dataaug val
# ./grid_search_qsub_step2.sh CRC_otu raw none domaincorr val
# ./grid_search_qsub_step2.sh CRC_thomas_otu raw none domaincorr val
...
# ./grid_search_qsub_step2.sh AGP_max_k7 raw none dataaug val
