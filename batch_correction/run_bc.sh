...
while read -r arg_1 arg_2 arg_3 arg_4 arg_5 arg_6 arg_7 arg_8 arg_9 arg_10 arg_11 arg_12 arg_13 arg_14 arg_15 arg_16 arg_17; do 
	Rscript --no-restore batch_correction_pipeline_basic.R ${arg_1} ${arg_2} ${arg_3} ${arg_4} ${arg_5} ${arg_6} ${arg_7} ${arg_8} ${arg_9} ${arg_10} ${arg_11} ${arg_12} ${arg_13} ${arg_14} ${arg_15} ${arg_16} ${arg_17}
