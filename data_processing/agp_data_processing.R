...
# ============================================================================== #
# load kmer_data
kmer_table = read.table(paste0(folder,"kmer_matrix_5.csv"),header=TRUE,stringsAsFactors=FALSE,sep=",",as.is=TRUE,row.names = 1,check.names = FALSE)
# convert na to 0
...
# get shared samples
common_samples = intersect(AGP_total_metadata$Run,colnames(kmer_table))
